            ...
            <table>
                ...
                <tbody>
                    ...
                    @foreach ($cartes as $carte)
                        ...
                        @endphp
                        <tr>
                            <th><a href="{{ route('cartedetails', ['id' => $carte->id]) }}">{{ $i }}
                                </a></th>
                            <td><a href="{{ route('cartedetails', ['id' => $carte->id]) }}">{{ $carte->objet }}</a>
                            </td>
                            <td><a href="{{ route('cartedetails', ['id' => $carte->id]) }}">{{ $carte->etat }}</a>
                            </td>
                            <td><a
                                    href="{{ route('cartedetails', ['id' => $carte->id]) }}">{{ $carte->updated_at->format('d M Y à H:i') }}</a>
                            </td>
                            <td><a
                                    href="{{ route('cartedetails', ['id' => $carte->id]) }}">{{ $carte->created_at->format('d M Y à H:i') }}</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
