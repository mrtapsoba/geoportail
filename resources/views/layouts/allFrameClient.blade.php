        ...
        <div class="my-nav ">
            ...
            <div class="menu-btn">
                ...
                <a href="{{ route('clientProfile') }}" @yield('moncompte')><i class="ic fas fa-ticket-simple"></i>Mon
                    compte</a>
                <a href="{{ route('mescartes') }}" @yield('mescartes')><i class="ic fas fa-list"></i>Mes cartes</a>
                <a href="{{ route('contributionClient') }}" @yield('contribution')><i
                        class="ic fa-solid fa-cart-shopping"></i>Contributions</a>
                <a href="{{ route('demandeClient') }}" @yield('demande')><i
        ...
        <div class="my-nav-phone">
            ...
            <div class="menu-btn">
                ...
                <a href="{{ route('clientProfile') }}" @yield('moncomptePhone')><i class="ic fas fa-ticket-simple"></i>Mon
                    compte</a>
                <a href="{{ route('mescartes') }}" @yield('mescartesPhone')><i class="ic fas fa-list"></i>Mes cartes</a>
                <a href="{{ route('contributionClient') }}" @yield('contributionPhone')><i
                        class="ic fa-solid fa-cart-shopping"></i>Contributions</a>
                <a href="{{ route('demandeClient') }}" @yield('demandePhone')><i
                        class="ic fa-solid fa-cart-shopping"></i>Demandes</a>
            </div>
        </div>
        <div class="contents">
